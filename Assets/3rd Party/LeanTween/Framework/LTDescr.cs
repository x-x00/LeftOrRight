	...
	public LTDescr setColor(){
		...
		this.initInternal = ()=>{
			...
			if(renColor!=null){
				...
				if(trans.GetComponent<Renderer>()!=null && trans.GetComponent<Renderer>().sharedMaterial.HasProperty("_Color")){
					Color col = trans.GetComponent<Renderer>().sharedMaterial.color;
					this.setFromColor( col );
				}else if(trans.GetComponent<Renderer>()!=null && trans.GetComponent<Renderer>().sharedMaterial.HasProperty("_TintColor")){
					Color col = trans.GetComponent<Renderer>().sharedMaterial.GetColor ("_TintColor");
					this.setFromColor( col );
				}else if(trans.childCount>0){
					foreach (Transform child in trans) {
						if(child.gameObject.GetComponent<Renderer>()!=null){
							Color col = child.gameObject.GetComponent<Renderer>().sharedMaterial.color;
							this.setFromColor( col );
							break;
						}
					}
